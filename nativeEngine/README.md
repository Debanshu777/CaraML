...
- Desktop native hardening now verifies bounded calibration inputs and lock-free atomic cancellation; iOS builds export the same calibrated backend bridge
