...
- Desktop native verification now exercises llama operation exclusion, non-blocking cancellation, idempotent backend initialization, conservative unknown quantization, and fault-path model/context cleanup
