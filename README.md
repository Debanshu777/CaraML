...
- Case-distinct owner repairs never coalesce; a cancelled repair leader hands live followers one bounded shared successor without leaking cancellation or duplicating metadata writes, and every Model Hub download requires the durable coordinator with no direct Ready publication fallback
