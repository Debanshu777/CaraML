...
- Assessed diffusion backends now use stable CPU/Metal/Vulkan/CUDA ABI values across JNI and iOS; native preflight must exactly bind every configured component role/path ordinal and planned placement, while Vulkan safety follows the component's selected backend
