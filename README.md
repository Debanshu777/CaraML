...
- Model Hub now derives installed diffusion state from restart-validated artifact and aggregate manifests, restores interrupted generations idempotently, and ships the pinned-root native filesystem in Android and Desktop application images
