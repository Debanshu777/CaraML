...
- Downloads require pinned artifact identities and roots, stream SHA-256 into sibling `.part` files through descriptor-relative no-follow operations, and publish destination-bound per-artifact and aggregate v1 manifests through durable, evidence-validated recovery transactions
