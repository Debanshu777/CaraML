...
Final fix G review round 2/5: 1 Important addressed, 0 open — preflight now keeps configured source role/path ordinals losslessly separate from bundle-internal tensor subdivisions; contradictory/missing/extra sources fail closed, external TAESD remains distinct with VAE placement, split configs remain exact, and final gates pass (32 focused JVM; 1,096 JVM + native 5/5).
