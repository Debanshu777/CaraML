...
- Added a cancellable 3-second backend calibration probe with bounded synthetic buffers, validated numeric results, and the shared native session gate across JNI and iOS cinterop
