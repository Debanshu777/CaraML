...
- Android uses UIDT/foreground WorkManager notifications, iOS restores each background task's exact response-byte bound and terminally rejects oversized known or chunked responses, and Desktop recovers persisted download checkpoints at startup
