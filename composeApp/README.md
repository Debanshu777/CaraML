...
- Repair single-flight uses exact validated owner identity while normalized hashes only select bounded stripes; owner-lock cancellation is never converted into artifact failure, and the obsolete direct Ready publication path is gone
