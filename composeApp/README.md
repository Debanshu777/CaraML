...
- Quarantined-load permission and exact retry now share the current serialized model-load job, so switching models cancels stale retries before native work or UI mutation
