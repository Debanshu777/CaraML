...
- Android uses UIDT/foreground WorkManager notifications, iOS restores each background task's exact response bound and terminal rejection reason across relaunch, and Desktop recovers persisted download checkpoints at startup
